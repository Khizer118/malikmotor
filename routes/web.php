...
// Route::get('/my-account', [ContactController::class, 'myaccount'])
//     ->name('myaccount')
//     ->middleware('auth');
...
Route::get('rentnow/serach',[BookingController::class,'search'])->name('search');
...
Route::middleware('auth')->group(function () {
    // My Account page aap ke paas already hai (blade view)
...
// My Account route (with bookings)
Route::get('/my-account', function () {
