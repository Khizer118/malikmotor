...
<div class="container">
    <div class="d-flex align-items-center justify-content-between py-3">
        <div class="d-flex align-items-center gap-3">
            <img src="{{ asset('images/logo.jpg') }}" alt="Malik Motors Logo" class="rounded" style="width:56px;height:56px;object-fit:cover;" />
            <a href="{{ url('/') }}" class="text-decoration-none text-dark"><h1 class="h4 m-0">Malik Motors</h1></a>
        </div>
       <div class="nav-wrapper d-flex align-items-center gap-3">
    <nav class="navigation d-none d-md-flex gap-3">
        <a href="{{ url('/') }}" class="text-decoration-none">Home</a>
        <a href="{{ url('/about') }}" class="text-decoration-none">About</a>
        <a href="{{ url('/contact-us') }}" class="text-decoration-none">Contact Us</a>
        <a href="{{ url('/rent-now') }}" class="text-decoration-none fw-semibold">Rent Now</a>
    </nav>
    ...
    @else
        ...
        <form action="{{ route('search') }}" method="GET" class="d-flex align-items-center">
            <input type="text" name="search" placeholder="Search..." class="form-control form-control-sm me-2" style="max-width:150px;">
            <button type="submit" class="login">Search</button>
        </form>
    @endif
</div>
...
<div class="section text-center py-2 bg-light">100% trusted car rental platform in Pakistan</div>
        ...
        @forelse($cars ?? [] as $car)
            <div class="mm-vehicle-card">
                ...
                <div class="mm-vehicle-content">
                    ...
                    @if(Auth::check())
                        <!-- ✅ Logged in users ko booking form ka button -->
                        <button type="button" 
                                class="mm-btn-select" 
                                data-car-id="{{ $car->id }}" 
                    ...
                    @else
                        <!-- ❌ Guest users ko Register/Login modal khulega -->
                        <button type="button" class="mm-btn-select" data-bs-toggle="modal" data-bs-target="#registrationModal">
                            Register to Book
                        </button>
                    @endif
                </div>
